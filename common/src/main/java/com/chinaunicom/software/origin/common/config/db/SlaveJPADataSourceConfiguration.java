...
//@Configuration
@EnableJpaRepositories(basePackages = {SlaveJPADataSourceConfiguration.REPOSITORY_BASE_PACKAGES}, entityManagerFactoryRef = SlaveJPADataSourceConfiguration.LOCAL_CONTAINER_ENTITY_MANAGER_FACTORY_BEAN, transactionManagerRef = SlaveJPADataSourceConfiguration.PLATFORM_TRANSACTION_MANAGER_BEAN)
@ConditionalOnClass({DataSource.class, EmbeddedDatabaseType.class})
public class SlaveJPADataSourceConfiguration extends JpaBaseDataSourceConfiguration {
    // 修改此处
    private final static String SPECIAL_NAME = "slave";

    public final static String REPOSITORY_BASE_PACKAGES = "com.chinaunicom.software.origin.db." + SPECIAL_NAME + ".mapper";
    public final static String ENTITY_BASE_PACKAGES = "com.chinaunicom.software.origin.db." + SPECIAL_NAME + ".model";
